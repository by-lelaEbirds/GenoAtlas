...
import { Check, Clock, Coins, Home, MapPin, RefreshCw, Share2, Sparkles, Trophy } from 'lucide-react';
  ...
  return (
    <div className={`absolute inset-0 z-50 flex items-center justify-center overflow-y-auto custom-scrollbar px-4 py-10 md:px-6 ${isDarkMode ? 'bg-black/80' : 'bg-stone-900/80'} animate-fade-in-up`}>
      <section
        ...
        className={`${isDarkMode ? 'glass-panel shadow-[0_30px_60px_rgba(0,0,0,0.8)]' : 'glass-panel-light shadow-2xl'} relative my-auto flex w-full max-w-lg flex-col rounded-[3rem] p-6 text-center md:rounded-[4rem] md:p-10`}
      >
        {isNewRecord && (
