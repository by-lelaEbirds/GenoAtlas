        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-sky-900/80 backdrop-blur-md px-6 animate-fade-in-up">
          <div className="bg-white border-b-[12px] border-stone-200 p-12 rounded-[4rem] max-w-2xl w-full shadow-2xl relative flex flex-col max-h-[90dvh]">
            ...
            <div className="grid grid-cols-2 gap-6 overflow-y-auto custom-scrollbar pb-4 pr-2">
              <button onClick={() => handleRegionSelect('all')} className="col-span-2 bg-gradient-to-r from-sky-400 to-sky-500 rounded-[2.5rem] p-8 flex items-center justify-center gap-6 border-b-[8px] border-sky-600 shadow-lg active:translate-y-[8px] active:border-b-0 transition-all">
                <span className="text-[64px] leading-none drop-shadow-md">🌍</span>
                <span className="text-[32px] font-black text-white uppercase tracking-widest mt-2 drop-shadow-sm">Mundo Todo</span>
              </button>
              
              <button onClick={() => handleRegionSelect('Americas')} className="bg-emerald-50 border-[8px] border-b-[12px] border-emerald-200 rounded-[2.5rem] p-6 flex flex-col items-center justify-center gap-4 shadow-sm hover:bg-emerald-100 active:translate-y-[12px] active:border-b-[8px] transition-all">
                <span className="text-[56px] leading-none drop-shadow-sm">🌎</span>
                <span className="text-[24px] font-black text-emerald-800 uppercase tracking-widest">Américas</span>
              </button>

              <button onClick={() => handleRegionSelect('Europe')} className="bg-indigo-50 border-[8px] border-b-[12px] border-indigo-200 rounded-[2.5rem] p-6 flex flex-col items-center justify-center gap-4 shadow-sm hover:bg-indigo-100 active:translate-y-[12px] active:border-b-[8px] transition-all">
                <span className="text-[56px] leading-none drop-shadow-sm">🏰</span>
                <span className="text-[24px] font-black text-indigo-800 uppercase tracking-widest">Europa</span>
              </button>
              
              <button onClick={() => handleRegionSelect('Asia')} className="bg-rose-50 border-[8px] border-b-[12px] border-rose-200 rounded-[2.5rem] p-6 flex flex-col items-center justify-center gap-4 shadow-sm hover:bg-rose-100 active:translate-y-[12px] active:border-b-[8px] transition-all">
                <span className="text-[56px] leading-none drop-shadow-sm">⛩️</span>
                <span className="text-[24px] font-black text-rose-800 uppercase tracking-widest">Ásia</span>
              </button>

              <button onClick={() => handleRegionSelect('Africa')} className="bg-amber-50 border-[8px] border-b-[12px] border-amber-200 rounded-[2.5rem] p-6 flex flex-col items-center justify-center gap-4 shadow-sm hover:bg-amber-100 active:translate-y-[12px] active:border-b-[8px] transition-all">
                <span className="text-[56px] leading-none drop-shadow-sm">🦁</span>
                <span className="text-[24px] font-black text-amber-800 uppercase tracking-widest">África</span>
              </button>

              <button onClick={() => handleRegionSelect('Oceania')} className="col-span-2 bg-teal-50 border-[8px] border-b-[12px] border-teal-200 rounded-[2.5rem] p-8 flex items-center justify-center gap-6 shadow-sm hover:bg-teal-100 active:translate-y-[12px] active:border-b-[8px] transition-all mt-2">
                <span className="text-[64px] leading-none drop-shadow-sm">🦘</span>
                <span className="text-[32px] font-black text-teal-800 uppercase tracking-widest mt-2">Oceania</span>
              </button>
            </div>
